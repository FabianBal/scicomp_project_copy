...
// const ROWS: i32 = 3;
// const COLS: i32 = 3;
// const NNZ: i32 = 4; // Number of non-zero elements
...
// fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    //         COLS,
    //         NNZ,
    //         d_csr_row_ptr.as_device_ptr().as_raw_mut(),
    //         d_csr_col_ind.as_device_ptr().as_raw_mut(),
    //         d_csr_values.as_device_ptr().as_raw_mut(),
    ...
    //         d_dense_matrix.as_device_ptr().as_raw_mut(),
    //         cudaDataType::CUDA_R_32F,
    ...
    //         COLS,
    //         COLS,
    //         d_result_matrix.as_device_ptr().as_raw_mut(),
    //         cudaDataType::CUDA_R_32F,
    //         cusparseOrder_t::CUSPARSE_ORDER_ROW,
    //     );
    // }
    ...
    //         cudaDataType::CUDA_R_32F,
    //         cusparseSpMMAlg_t::CUSPARSE_SPMM_ALG_DEFAULT,
    //         d_buffer.as_device_ptr().as_raw_mut(),
    //     );
    // }
